...
//            [[NSNotificationCenter defaultCenter] postNotificationName:@"NetWorkChanged" object:[NSNumber numberWithInteger:status]];
            if ([[HWNetworkReachabilityManager shareManager] networkReachabilityStatus] == AFNetworkReachabilityStatusNotReachable) {
                [[NSNotificationCenter defaultCenter] postNotificationName:@"stoploadFile"
                                                                    object:nil];        //dowloadFile
              }else {
                [[NSNotificationCenter defaultCenter] postNotificationName:@"startdowloadFile"
                                                                            object:nil]; //stoploadFile
