...
export default class AIGestureBoneView extends React.Component {
  props: {
    navigation: Object,
    language: String,
    user: Object,
  ...
  back = () => {
    NavigationService.goBack('AIGestureBoneView')
    ...
    return (
      <View style={styles.toolbar}>
        <View style={styles.buttonView}>
          <TouchableOpacity
            onPress={() => {
              SGestureBoneView.setAssociationMap(!this.state.associationMap)
              this.setState({
      ...
      <View style={[styles.container, { backgroundColor: color.transView }]}>
        <View style={[styles.container, { backgroundColor: color.transView }]}>
          ...
          >
            ...
            >
              <SMAIGestureBoneView style={{ flex: 1 }} />
              {// this.state.associationMap &&
              // !this.state.poseOverLook &&
