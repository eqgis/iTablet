...
class CollectSceneFormSet extends Component {
  ...
  DATUMPOINTVIEWSET: MapSelectPointLatitudeAndLongitude | null = null
  ...
  getFixedPosition = async () => {
    const fiexdPoint = await SCollectSceneFormView.getFixedPosition()
  ...
  getCurrentPosition = async () => {
    ...
    this.DATUMPOINTVIEWSET && this.DATUMPOINTVIEWSET.updateLatitudeAndLongitude({x: map.longitude, y: map.latitude})
        ...
        <View style={styles.item}>
          ...
          <View style={styles.switchItem}>
            <TextInput
              ...
              onChangeText={text => {
                const Tolerance = this.clearNoNum(text)
                this.setState({
                  Tolerance: Tolerance,
                })
              }}
      ...
      <TouchableOpacity
        ...
        onPress={async () => {
          if(this.fixedPositions){
            const point = this.DATUMPOINTVIEWSET && this.DATUMPOINTVIEWSET.getLatitudeAndLongitude()
