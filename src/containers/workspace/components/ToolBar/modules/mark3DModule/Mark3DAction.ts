...
function createPoint() {
  ...
  try {
    ...
    SScene.setAction(Action3D.CREATEPOINT3D)
    Scene3DLabelManager.drawFavorite()
...
function createText() {
  ...
  try {
    ...
    SScene.setAction(Action3D.CREATEPOINT3D)
    Scene3DLabelManager.drawText3D()
...
function createLine() {
  ...
  SScene.setAction(Action3D.CREATEPOINT3D)
  Scene3DLabelManager.drawLine3D()
  try {
...
function createRegion() {
  ...
  try {
    ...
    SScene.setAction(Action3D.CREATEPOINT3D)
    Scene3DLabelManager.drawRegion3D()
...
function clearPlotting() {
  ...
  Scene3DLabelManager.clearLabelLayer()
