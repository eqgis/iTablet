...
export type ToolbarModuleKey = ''
| keyof LEGEND_CONST
| keyof NAVIGATION_CONST
| keyof MAP_SETTINGS_CONST
| keyof MAP_MARKS_CONST
| keyof TOUCHPROGRESS_CONST
| keyof MAP_START_CONST
| keyof MAP_ADD_CONST
| keyof MAP_EDIT_CONST
| keyof MAP_THEME_CONST
| keyof MAP_STYLE_CONST
| keyof MAP_TOOL_CONST
| keyof MAP_COLLECTION_CONST
| keyof PLOT_ANIMATION_CONST
| keyof MAP_ANALYSIS_CONST
| keyof MAP_PROCESS_CONST
| keyof LAYER_SETTING_CONST
| keyof MAP_LAYER_VISIBLE_CONST
| keyof MAP_AR_CONST
| keyof MAP_AI_ANALIST_CONST
| keyof MAP_AI_AGGREGATE_CONST
| keyof MAP_AI_VEHICLE_CONST
| keyof MAP_AI_CATEGORY_CONST
| keyof MAP_SHARE_CONST

| keyof MAP3D_CONST
| keyof MAP3D_START_CONST
| keyof MAP3D_MARK_CONST
| keyof MAP3D_TOOL_CONST
| keyof MAP3D_FLY_CONST
| keyof MAP3D_LAYER3D_CONST
| keyof MAP3D_SHARE_CONST

| keyof MAP_COLOR_CONST
| keyof LAYER_TOOLBAR_CONST

| keyof SM_ARSCENEMODULE_CONST
| keyof MAP_BASE_CONST
| keyof MAP_SERVICE_CONST

| keyof AR_DRAWING_CONST
| keyof AR_START_CONST
| keyof AR_EDIT_CONST
| keyof AR_STYLE_CONST
...
interface NAVIGATION_CONST {
  ...
  SM_MAP_TOPO_COLLECTION_UNDO:'SM_MAP_TOPO_COLLECTION_UNDO'
  SM_MAP_TOPO_COLLECTION_REDO:'SM_MAP_TOPO_COLLECTION_REDO'
}

//地图设置
interface MAP_SETTINGS_CONST {
...
/** 图层设置 **/
interface MAP_LAYER_VISIBLE_CONST {
...
interface MAP_MARKS_CONST {
  ...
  SM_MAP_MARKS_TAGGING_EDIT_PLOT: 'SM_MAP_MARKS_TAGGING_EDIT_PLOT'
  //非CAD图层编辑 无风格
...
/** 推演动画 **/
interface PLOT_ANIMATION_CONST {
...
/** 处理模块 **/
interface MAP_PROCESS_CONST {
  SM_MAP_PROCESS: 'SM_MAP_PROCESS'                                                 // 分析处理，模块类型
}

/** 图层设置 **/
interface LAYER_SETTING_CONST {
...
/** 采集模块 **/
interface MAP_COLLECTION_CONST {
...
/** 三维开始模块 **/
interface MAP3D_START_CONST {
  SM_MAP3D_START: 'SM_MAP3D_START'                         // 三维开始模块，模块类型
}

/** MAP_AR视频地图模块 **/
interface MAP_AR_CONST {
...
/** AI目标识别模块 **/
interface MAP_AI_ANALIST_CONST {
  SM_MAP_AI_ANALYSIS: 'SM_MAP_AI_ANALYSIS'                 // AI目标识别
  SM_MAP_AI_ANALYSIS_DETECT: 'SM_MAP_AI_ANALYSIS_DETECT'   // AI目标检测
  SM_MAP_AI_ANALYSIS_PREVIEW: 'SM_MAP_AI_ANALYSIS_PREVIEW'   // AI目标检测预览
}

/** AI聚合模块 **/
interface MAP_AI_AGGREGATE_CONST {
  SM_MAP_AI_AGGREGATE: 'SM_MAP_AI_AGGREGATE'                 // AI聚合
  SM_MAP_AI_AGGREGATE_DETECT: 'SM_MAP_AI_AGGREGATE_DETECT'   // AI聚合检测
  SM_MAP_AI_AGGREGATE_PREVIEW: 'SM_MAP_AI_AGGREGATE_PREVIEW'   // AI聚合检测预览
}

/** AI车辆采集模块 **/
interface MAP_AI_VEHICLE_CONST {
  SM_MAP_AI_VEHICLE: 'SM_MAP_AI_VEHICLE'                 // AI车辆采集模块
  SM_MAP_AI_VEHICLE_DETECT: 'SM_MAP_AI_VEHICLE_DETECT'   // AI车辆检测
  SM_MAP_AI_VEHICLE_PREVIEW: 'SM_MAP_AI_VEHICLE_PREVIEW' // AI车辆检测预览
}

/** AI分类模块 **/
interface MAP_AI_CATEGORY_CONST {
  SM_MAP_AI_CATEGORY: 'SM_MAP_AI_CATEGORY'                 // AI车辆采集模块
  SM_MAP_AI_CATEGORY_DETECT: 'SM_MAP_AI_CATEGORY_DETECT'   // AI分类检测
  SM_MAP_AI_CATEGORY_PREVIEW: 'SM_MAP_AI_CATEGORY_PREVIEW' // AI分类检测预览
}

/** 二维分享 **/
interface MAP_SHARE_CONST {
  SM_MAP_SHARE: 'SM_MAP_SHARE'
}

/** 三维分享 **/
interface MAP3D_SHARE_CONST {
  SM_MAP3D_SHARE: 'SM_MAP3D_SHARE'
}

/** 三维未分类的常量 **/
interface MAP3D_CONST {
...
/** MAP_AR三维管线 **/
interface SM_ARSCENEMODULE_CONST {
  /** 三维AR管线界面菜单 **/
...
/** 三维分享 **/
interface MAP_BASE_CONST {
  SM_MAP_BASE_CHANGE: 'SM_BASE_MAP_CHANGE'
}

/** 数据服务 **/
interface MAP_SERVICE_CONST {
  ...
  SM_MAP_SERVICE_UPLOAD: 'SM_MAP_SERVICE_UPLOAD'
  SM_MAP_SERVICE_UPDATE: 'SM_MAP_SERVICE_UPDATE'
}

/** AR制图 **/
interface AR_DRAWING_CONST {
  ...
  SM_AR_DRAWING_BUBBLE_TEXT: 'SM_AR_DRAWING_BUBBLE_TEXT'
  SM_AR_DRAWING_SAND: 'SM_AR_DRAWING_SAND'
  SM_AR_DRAWING_D_MODAL: 'SM_AR_DRAWING_D_MODAL'

  SM_AR_DRAWING_ADD_BROCHORE:'SM_AR_DRAWING_ADD_BROCHORE'
  SM_AR_DRAWING_ADD_SAND_TABLE_ALBUM:'SM_AR_DRAWING_ADD_SAND_TABLE_ALBUM'
  SM_AR_DRAWING_ADD_ATTRIBUTE_WIDGET:'SM_AR_DRAWING_ADD_ATTRIBUTE_WIDGET'
  SM_AR_DRAWING_ADD_WIDGET:'SM_AR_DRAWING_ADD_WIDGET'
  SM_AR_DRAWING_ADD_VIDEO_ALBUM:'SM_AR_DRAWING_ADD_VIDEO_ALBUM'
  SM_AR_DRAWING_ADD_LINE:'SM_AR_DRAWING_ADD_LINE'
  SM_AR_DRAWING_ADD_MARKER_LINE:'SM_AR_DRAWING_ADD_MARKER_LINE'
  SM_AR_DRAWING_ADD_SAND: 'SM_AR_DRAWING_ADD_SAND'
  SM_AR_DRAWING_ADD_BAR_CHART: 'SM_AR_DRAWING_ADD_BAR_CHART'
  SM_AR_DRAWING_ADD_PIE_CHART: 'SM_AR_DRAWING_ADD_PIE_CHART'

  /** AR打点添加 **/
  SM_AR_DRAWING_ADD_POINT: 'SM_AR_DRAWING_ADD_POINT'

  SM_AR_ATTRIBUTE_ALBUM:'SM_AR_ATTRIBUTE_ALBUM'
  SM_AR_VIDEO_ALBUM:'SM_AR_VIDEO_ALBUM'
  SM_AR_MAPBROCHORE:'SM_AR_MAPBROCHORE'
  SM_AR_SANDTABLE_ALBUM:'SM_AR_SANDTABLE_ALBUM'
  SM_AR_POI_SETTING:'SM_AR_POI_SETTING'
  SM_AR_BAR_CHART: 'SM_AR_BAR_CHART'
  SM_AR_PIE_CHART: 'SM_AR_PIE_CHART'
}

interface AR_START_CONST {
...
interface AR_EDIT_CONST {
  ...
  SM_AR_EDIT_SETTING:'SM_AR_EDIT_SETTING'
  SM_AR_EDIT_SETTING_IITLE:'SM_AR_EDIT_SETTING_IITLE'
  SM_AR_EDIT_SETTING_BACKGROUND:'SM_AR_EDIT_SETTING_BACKGROUND'
  SM_AR_EDIT_SETTING_BACKGROUND_OPACITY:'SM_AR_EDIT_SETTING_BACKGROUND_OPACITY'
  SM_AR_EDIT_SETTING_BACKGROUND_BORDER_COLOR:'SM_AR_EDIT_SETTING_BACKGROUND_BORDER_COLOR'
  SM_AR_EDIT_SETTING_BACKGROUND_BORDER_WIDTH:'SM_AR_EDIT_SETTING_BACKGROUND_BORDER_WIDTH'
  SM_AR_EDIT_SETTING_ARRAY:'SM_AR_EDIT_SETTING_ARRAY'
  SM_AR_EDIT_SETTING_IITLE_ALBUM_COLOR:'SM_AR_EDIT_SETTING_IITLE_ALBUM_COLOR'
  SM_AR_EDIT_SETTING_IITLE_ALBUM_LINE_COLOR:'SM_AR_EDIT_SETTING_IITLE_ALBUM_LINE_COLOR'
  SM_AR_EDIT_SETTING_IITLE_ALBUM_TIME_COLOR:'SM_AR_EDIT_SETTING_IITLE_ALBUM_TIME_COLOR'
  SM_AR_EDIT_SETTING_IITLE_TEXT_SIZE:'SM_AR_EDIT_SETTING_IITLE_TEXT_SIZE'
  SM_AR_EDIT_SETTING_IITLE_COLOR:'SM_AR_EDIT_SETTING_IITLE_COLOR'
  SM_AR_EDIT_SETTING_IITLE_TEXT:'SM_AR_EDIT_SETTING_IITLE_TEXT'  // 设置标题文字
  SM_AR_EDIT_SETTING_CHART_DATA:'SM_AR_EDIT_SETTING_CHART_DATA'  // 设置图标的数据
  SM_AR_EDIT_SETTING_IITLE_ROTATION_ANGLE:'SM_AR_EDIT_SETTING_IITLE_ROTATION_ANGLE'
  SM_AR_EDIT_SETTING_IITLE_OPACITY:'SM_AR_EDIT_SETTING_IITLE_OPACITY'
  SM_AR_EDIT_SETTING_IITLE_BUTTON_TEXT_SIZE:'SM_AR_EDIT_SETTING_IITLE_BUTTON_TEXT_SIZE'
  SM_AR_EDIT_VERTEX_ADD_LINE:'SM_AR_EDIT_VERTEX_ADD_LINE'
  SM_AR_EDIT_VERTEX_ADD_LINE_ATPOINT:'SM_AR_EDIT_VERTEX_ADD_LINE_ATPOINT'
  ...
  SM_AR_EDIT_ANIMATION_BONE_ANIMATION: 'SM_AR_EDIT_ANIMATION_BONE_ANIMATION'

  SM_AR_EDIT_LAYER_VISIBLE_BOUNDS: 'SM_AR_EDIT_LAYER_VISIBLE_BOUNDS'
  // 特效图层可见距离
  SM_AR_EDIT_EFFECT_LAYER_VISIBLE_BOUNDS: 'SM_AR_EDIT_EFFECT_LAYER_VISIBLE_BOUNDS'
  // 特效图层持续时间
  SM_AR_EDIT_EFFECT_LAYER_SECONDS_TO_PLAY: 'SM_AR_EDIT_EFFECT_LAYER_SECONDS_TO_PLAY'
}

interface AR_STYLE_CONST {
...
interface AR_NAVI_CONST {
  SM_AR_NAVI: 'SM_AR_NAVI'
}

type SM_MAP_MEDIA = 'SM_MAP_MEDIA'