    ...
    action: () => {
      ...
      GLOBAL.toolBox &&
        GLOBAL.toolBox.setVisible(
          true,
          ConstToolType.MAP_TOOL_TAGGING_STYLE_LINE,
          {
...
const point = param => [
  {
    ...
    action: () => {
      ...
      GLOBAL.toolBox &&
        GLOBAL.toolBox.setVisible(
          true,
          ConstToolType.MAP_TOOL_TAGGING_STYLE_POINT,
          {
            containerType: ToolbarType.symbol,
            isFullScreen: false,
            // column,
...
const region = param => [
  {
    ...
    action: () => {
      ...
      GLOBAL.toolBox &&
        GLOBAL.toolBox.setVisible(
          true,
          ConstToolType.MAP_TOOL_TAGGING_STYLE_REGION,
          {
            containerType: ToolbarType.symbol,
            isFullScreen: false,
            // column,
...
export { line, point, region, text, colors, colorsWithNull, pickerData }
