export default {
  ...
  MAP_THEME_PARAM_UNIFORMLABEL_BACKSHAPE_NONE: '0', // '空背景'
  MAP_THEME_PARAM_UNIFORMLABEL_BACKSHAPE_DIAMOND: '4', // '菱形背景'
  MAP_THEME_PARAM_UNIFORMLABEL_BACKSHAPE_ROUNDRECT: '2', // '圆角矩形背景'
  MAP_THEME_PARAM_UNIFORMLABEL_BACKSHAPE_RECT: '1', // '矩形背景'
  MAP_THEME_PARAM_UNIFORMLABEL_BACKSHAPE_ELLIPSE: '3', // '椭圆形背景'
  MAP_THEME_PARAM_UNIFORMLABEL_BACKSHAPE_TRIANGLE: '5', // '三角形背景'
  MAP_THEME_PARAM_UNIFORMLABEL_BACKSHAPE_MARKER: '100', // '符号背景'
  ...
  //==================导航采集====================
  MAP_INCREMENT_START: 'MAP_INCREMENT_START', //开始
  MAP_INCREMENT_STOP: 'MAP_INCREMENT_STOP', //停止
  MAP_INCREMENT_ADD_POINT: 'MAP_INCREMENT_ADD_POINT', //添加点
  MAP_INCREMENT_CANCEL: 'MAP_INCREMENT_CANCEL', // 取消
  MAP_INCREMENT_COMMIT: 'MAP_INCREMENT_COMMIT', //提交
  ...
  MAP_TOPO_MOVE_OBJECT: 'MAP_TOPO_MOVE_OBJECT', //平移对象
  MAP_TOPO_ADD_NODE: 'MAP_INCREMENT_ADD_NODE', //添加节点
  MAP_TOPO_EDIT_NODE: 'MAP_INCREMENT_EDIT_NODE', //编辑节点
  MAP_TOPO_DELETE_NODE: 'MAP_INCREMENT_DELETE_NODE', //删除节点
  MAP_TOPO_DELETE_OBJECT: 'MAP_TOPO_DELETE_OBJECT', //删除对象
  MAP_TOPO_SMOOTH: 'MAP_TOPO_SMOOTH', //平滑
  MAP_TOPO_SPLIT_LINE: 'MAP_TOPO_SPLIT_LINE', //线线打断
  MAP_TOPO_SPLIT: 'MAP_TOPO_SPLIT', //打断
  MAP_TOPO_EXTEND: 'MAP_TOPO_EXTEND', //延伸
