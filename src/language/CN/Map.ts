...
const Map_Main_Menu = {
  ...
  MAP_AR_AI_ASSISTANT_MEASURE_AREA_POLYGON_TITLE: '多边形测量',
  MAP_AR_AI_ASSISTANT_MEASURE_AREA_RECTANGLE_TITLE: '矩形测量',
  MAP_AR_AI_ASSISTANT_MEASURE_AREA_CIRCULAR_TITLE: '圆形测量',
