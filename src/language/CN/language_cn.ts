...
export const language_cn = {
  ...
  ANCHOR_POINT_ONE:'定位点1',
  ANCHOR_POINT_TWO:'定位点2',
  COORD_PARAM:'坐标',
  AIM_REAL_POSITION: "请对准实景正射位置",
  SELECT_FIRST_POSITION_POINT:'选择第一个定位点',
  SELECT_SECOND_POSITION_POINT:'选择第二个定位点',
