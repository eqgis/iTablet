...
export const language_cn = {
  ...
  ARFLATMAP:"AR平面地图",
  ARBUILDING:"AR超图大厦",
  EXITEXHIBITION:"是否退出展厅应用？",
  SEARCHCLOSE:"查询关闭",
  SEARCHSTART:"查询开启，请点击模型查询属性",
  ADJUSTMENT:"调整",
  SHAPE:"形状",
  TEXTTURE:"纹理",
  TRAFFIC:"车流",
  ...
  FLLOW_THE_ARROW:"请按照箭头引导转动屏幕查看地图",
  PANORAMA:"全景",
  ROLLER:"卷帘",
  HOLE:"挖洞",
  FLOW:"流向",
  ...
  LINK_TYPE:"链接类型",
  ROUTINE:"常规",
  SECTION_DIAMETER:"截面直径",
  POSITION_ADJUST:"位置调整",
  SCAN_TOP:"请对准演示台上二维码进行扫描",
  SCAN_BOTTOM:"请对准地面上的二维码进行扫描",
  DEEP:"深度",
  HOLE_ADJUST:"挖洞调整",
  LIGHT:"洞见之光",
  MISSION:"企业使命",
  ...
  GROUP_PHOTO:"合影",
  TAKE_VIDEO:"录像",
  PLEASE_WAIT_AND_EXIT:"请等待数据加载完成再退出!",
  SVAE_LOCAL:"保存到本地",
  SHARE_TO_WECHAT:"分享到微信",
  FOLLOW_ARROW:"请按照箭头引导转动屏幕查看内容",
  SEARCH1:"查询",
  FIGURE:"配图",
  ZOOM:"缩放",
  MOUTAIN:"登山",
