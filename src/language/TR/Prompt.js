...
const Prompt = {
  ...
  FILENAME_ALREADY_EXIST: 'Dosya zaten var, lütfen dosya adını tekrar girin',
  NETWORK_BUILDING: 'Ağda ...',
  BUILD_SUCCESS: 'Karayolu ağı başarıyla inşa edildi',
  ...
  SELECT_EXTEND_LINE: 'Lütfen uzatılması gereken satırı seçin',
  SELECT_SECOND_LINE: 'Lütfen ikinci satırı seçin',
